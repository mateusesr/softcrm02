...
class ClientSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $clients = [
            ...
            ['city_id' => 1, 'name' => 'João da Silva2', 'email' => 'joao.silva2@example.com', 'phone' => '11912345678', 'is_active' => 1],
            ['city_id' => 1, 'name' => 'João da Silva3', 'email' => 'joao.silva3@example.com', 'phone' => '11912345678', 'is_active' => 1],
            ['city_id' => 2, 'name' => 'Maria Oliveira', 'email' => 'maria.oliveira@example.com', 'phone' => '21923456789', 'is_active' => 1],
            ['city_id' => 2, 'name' => 'Maria Oliveira2', 'email' => 'maria.oliveira2@example.com', 'phone' => '21923456789', 'is_active' => 1],
            ...
            ['city_id' => 5, 'name' => 'Paula Mendes2', 'email' => 'paula.mendes2@example.com', 'phone' => '10123456789', 'is_active' => 1],
        ];
