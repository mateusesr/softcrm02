            ...
            <div class="container mx-auto flex justify-between header">
                <div class="flex space-x-4 navbar-left">
                    ...
                    <a href="{{ route('attendance.index') }}"
                        class="text-white hover:bg-gray-700 px-8 py-2 rounded">Atendimentos</a>
                    <a href="{{ route('type.index') }}" class="text-white hover:bg-gray-700 px-8 py-2 rounded">Tipos de
                        Atendimentos</a>
                    <a href="{{ route('city.index') }}"
                        class="text-white hover:bg-gray-700 px-8 py-2 rounded">Cidades</a>
                </div>
