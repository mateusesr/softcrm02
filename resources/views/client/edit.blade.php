...
<body>
    <div class="container">
        <h2 class="text-center mb-4" style="color: black; font-size: 24px;">Editar Cliente</h2>
        <form class="form-box" action="{{ route('client.update', $client->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-grid">
                ...
                <a href="{{ route('client.index', ['client_id' => $client->id]) }}" class="btn btn-secondary btn-cancel">Cancelar</a>
            </div>
        </form>
    </div>
</body>
