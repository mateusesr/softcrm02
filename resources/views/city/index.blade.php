...
<script>
    // Function to display the error message as a pop-up
    function showErrorMessage() {
        alert("Não foi possível excluir sua cidade.");
    }

    // Call the function when the page loads or when the error message is triggered
