...
<body>
    <div class="container">
        <h2 class="text-center mb-4" style="color: black; font-size: 24px;">Editar Cidade</h2>
        <form class="form-box" action="{{ route('city.update', $city->id) }}" method="POST" class="bg-white p-6 rounded shadow-md">
            @csrf
            @method('PUT')
            ...
            <div class="d-grid">
                ...
                <a href="{{ route('city.index', ['city_id' => $city->id]) }}" class="btn btn-secondary btn-cancel">Cancelar</a>
            </div>
        </form>
    </div>
</body>
